 ...
 */
public class FoliageColorLoader extends ReloadListener<int[]>
{
	...
	{
		try (InputStream stream = resourceManager.getResource(new ResourceLocation("ftbchunks", "foliage.png")).getInputStream())
		{
