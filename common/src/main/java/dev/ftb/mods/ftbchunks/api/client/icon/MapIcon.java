...
/// Represents an icon which can be drawn on the large map or minimap, typically a player, entity or waypoint.
public interface MapIcon {
    ...
    /// A simple implementation of `MapIcon` with a static position and adjustable icon, which may be more convenient to
