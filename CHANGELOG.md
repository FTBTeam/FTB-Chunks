...
### Fixed
* Fixed issues on open-to-LAN servers with unclaiming/forcelading other player's chunks

## [26.1.2.5]

### Fixed
* Fixed mixin application failure on Fabric
...
### Changed
* Now requires NeoForge 26.1.2.21-beta or later
