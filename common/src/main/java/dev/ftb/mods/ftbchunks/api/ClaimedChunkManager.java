...
public interface ClaimedChunkManager {
    ...
    /// `/ftbchunks admin bypass_protection` command).
    ///
    ...
    /// not extend `ServerPlayer` (fake players are OK as long as this the case)
    ///
    ...
    /// map is a long encoding of the chunk position; you can obtain the chunk pos via `new ChunkPos(long pos)`.
    ...
    Long2ObjectMap<UUID> getForceLoadedChunks(ResourceKey<Level> dimension);
