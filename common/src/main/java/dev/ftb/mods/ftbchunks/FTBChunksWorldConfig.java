...
public interface FTBChunksWorldConfig {
	...
	IntValue MAX_DESTROY_BLOCKS_PER_HOUR_OTHER = CONFIG.getInt("max_destroy_blocks_per_hour_other", 0).comment("If disable_protection = false, this many blocks that aren't in sub group tags can still be destroyed per hour be enemy players. 0 disables this.");
	IntValue MAX_DESTROY_BLOCKS_PER_HOUR_GROUP_1 = CONFIG.getInt("max_destroy_blocks_per_hour_group_1", 0).comment("If disable_protection = false, this many blocks in the count_breaks_1 tag can still be destroyed per hour be enemy players. 0 disables this.");
	IntValue MAX_DESTROY_BLOCKS_PER_HOUR_GROUP_2 = CONFIG.getInt("max_destroy_blocks_per_hour_group_2", 0).comment("If disable_protection = false, this many blocks in the count_breaks_2 tag can still be destroyed per hour be enemy players. 0 disables this.");
