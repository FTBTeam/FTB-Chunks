...
//		matrixStack.translate(-50, 50, 0);
		...
		if (FTBChunksClientConfig.DEBUG_INFO.get()) {
			...
			MINIMAP_TEXT_LIST.add(new TextComponent("Region: " + playerXZ.toRegionString() + " " + playerXZ));
			MINIMAP_TEXT_LIST.add(new TextComponent("Estimated Memory: " + StringUtils.formatDouble00(memory / 1024D / 1024D) + " MB"));
